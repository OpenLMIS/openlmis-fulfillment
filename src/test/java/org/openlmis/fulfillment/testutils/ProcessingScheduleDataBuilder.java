...
public class ProcessingScheduleDataBuilder {
  ...
  /**
   * Builder for {@link ProcessingScheduleDto}.
   */
  ...
  /**
   * Build instanceof {@link ProcessingScheduleDto}.
   */
  public ProcessingScheduleDto build() {
    ProcessingScheduleDto schedule =
        new ProcessingScheduleDto(code, description, modifiedDate, name);
    schedule.setId(id);
    return schedule;
  }
}
