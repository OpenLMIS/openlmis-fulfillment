...
@EqualsAndHashCode
@ToString
public class OrderLineItemExtraDataEntity {
  ...
  public OrderLineItemExtraDataEntity(Map<String, Object> importer) {
    updateFrom(importer);
  }

  static OrderLineItemExtraDataEntity defaultEntity(OrderLineItemExtraDataEntity entity) {
    return entity == null ? new OrderLineItemExtraDataEntity() : entity;
  }
