...
INSERT INTO order_file_columns (id, columnlabel, datafieldlabel, format, include, keypath, nested, openlmisfield, "position", related, relatedkeypath, orderfiletemplateid) VALUES ('6b8d331b-a0dd-4a1f-aafb-40e6a72ab9f6', 'Customer ID', 'fulfillment.header.customer.id', NULL, true, 'facilityId', 'order', true, 2, 'Facility', 'code', '457ed5b0-80d7-4cb6-af54-e3f6138c8128');
INSERT INTO order_file_columns (id, columnlabel, datafieldlabel, format, include, keypath, nested, openlmisfield, "position", related, relatedkeypath, orderfiletemplateid) VALUES ('cd57f329-f549-4717-882e-ecbf98122c39', 'Approved quantity', 'fulfillment.header.approved.quantity', NULL, true, 'orderedQuantity', 'lineItem', true, 5, NULL, NULL, '457ed5b0-80d7-4cb6-af54-e3f6138c8128');
...
INSERT INTO order_file_columns (id, columnlabel, datafieldlabel, format, include, keypath, nested, openlmisfield, "position", related, relatedkeypath, orderfiletemplateid) VALUES ('d6967c67-7ca3-4958-97f7-b1b1eccfa27d', 'Line Number', 'fulfillment.header.line.number', NULL, true, 'counter', 'line_no', true, 5, NULL, NULL, '457ed5b0-80d7-4cb6-af54-e3f6138c8128');
...
INSERT INTO order_file_columns (id, columnlabel, datafieldlabel, format, include, keypath, nested, openlmisfield, "position", related, relatedkeypath, orderfiletemplateid) VALUES ('351640d0-60bc-4b2d-a523-4c23cd4ef178', 'Price', 'fulfillment.header.price', NULL, true, 'price', 'lineItem', true, 5, NULL, NULL, '457ed5b0-80d7-4cb6-af54-e3f6138c8128');
